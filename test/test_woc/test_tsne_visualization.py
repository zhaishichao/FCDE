...
save_path_re_g1 = save_path + 're_g1/'
save_path_re_g2 = save_path + 're_g2/'
save_path_re_g3 = save_path + 're_g3/'
save_path_re_g4 = save_path + 're_g4/'
# 检查目录是否存在，如果不存在则创建
if not os.path.exists(save_path):
    os.makedirs(save_path)
if not os.path.exists(save_path_re_g1):
    os.makedirs(save_path_re_g1)
if not os.path.exists(save_path_re_g2):
    os.makedirs(save_path_re_g2)
if not os.path.exists(save_path_re_g3):
    os.makedirs(save_path_re_g3)
if not os.path.exists(save_path_re_g4):
    os.makedirs(save_path_re_g4)
