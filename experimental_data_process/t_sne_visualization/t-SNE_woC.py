...
root_path = "D:\\ApplicationDoc\\Downloads\\tsne\\woC\\"
save_dir = "./results/"
...
fig, axes = plt.subplots(1, 3, figsize=(18, 6))  # 1行3列，总尺寸18×6英寸
...
plt.savefig(os.path.join(save_dir, "wisconsin_woc.pdf"), dpi=300)  # dpi：分辨率，越大越清晰文件越大
plt.show()
