...
datasetnames_imbalanced_ratio = ['twonorm', 'ring', 'chess', 'sonar', 'banana', 'australian', 'heart', 'spambase',
                                 'wdbc', 'ionosphere',
                                 'glass1', 'magic', 'wisconsin', 'pima', 'iris0', 'glass0', 'titanic', 'german',
                                 'phoneme', 'yeast1',
                                 'haberman', 'vehicle2', 'adult', 'ecoli1', 'appendicitis', 'new-thyroid1', 'ecoli2',
                                 'segment0',
                                 'ecoli3', 'page-blocks0', 'yeast-0-2-5-6-vs-3-7-8-9', 'vowel0',
                                 'led7digit-0-2-4-5-6-7-8-9-vs-1',
                                 'cleveland-0-vs-4', 'ecoli-0-1-4-6-vs-5', 'shuttle-c0-vs-c4', 'yeast-1-vs-7',
                                 'coil2000', 'abalone9-18',
                                 'dermatology-6', 'shuttle-6-vs-2-3', 'yeast-2-vs-8', 'flare-F', 'car-good',
                                 'kr-vs-k-one-vs-fifteen',
                                 'yeast5', 'winequality-red-8-vs-6', 'winequality-white-3-vs-7',
...
datasetnames_instances = ['appendicitis', 'iris0', 'cleveland-0-vs-4', 'sonar', 'glass1', 'glass0', 'new-thyroid1',
                          ...
                          'ionosphere', 'dermatology-6', 'led7digit-0-2-4-5-6-7-8-9-vs-1', 'yeast-1-vs-7',
                          'yeast-2-vs-8', 'wdbc',
                          ...
                          'flare-F', 'yeast5', 'yeast1', 'poker-8-9-vs-6', 'car-good', 'shuttle-c0-vs-c4',
                          'abalone-20-vs-8-9-10',
                          'poker-8-9-vs-5', 'titanic', 'kddcup-rootkit-imap-vs-back', 'kr-vs-k-one-vs-fifteen',
                          'segment0',
...
datasetnames = ['australian', 'heart', 'spambase', 'wdbc', 'wisconsin',
                'pima', 'iris0', 'glass0', 'german', 'phoneme', 'yeast1', 'vehicle2',
                'ecoli1', 'appendicitis', 'new-thyroid1', 'ecoli2', 'segment0',
                'yeast-0-2-5-6-vs-3-7-8-9', 'led7digit-0-2-4-5-6-7-8-9-vs-1',
                'cleveland-0-vs-4', 'yeast-1-vs-7', 'shuttle-6-vs-2-3', 'yeast-2-vs-8',
